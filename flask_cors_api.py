...
def add_user():
  ...
  enterCourse = request.form['course']
  enterCourseYear = request.form['courseyear']
  ...
  if(x != None):
    ...
    userinfo = {
      ...
      "course":enterCourse,
      "courseyear":enterCourseYear,
      "address":{"state":enterState,"disctict":enterDisctict},
      "gender":enterGender
      }
